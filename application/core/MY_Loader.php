...
class MY_Loader extends CI_Loader
{
    ...
    function __construct()
    {
        ...
        {
            define('SPARKPATH', APPPATH . 'libraries/sparks/');
        }
    ...
    function object($class, $init = false)
    {
        if ( file_exists(APPPATH.'models/classes/'.$class.EXT) )
        {
            require_once(APPPATH.'models/classes/'.$class.EXT);
        }
        else
        {
            return FALSE;
